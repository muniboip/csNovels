...
const BillingComponent = ({ authReducer }) => {
  ...
  useEffect(async () => {
    ...
    console.log('====================================');
    console.log( authReducer?.userData?.package?.product);
    console.log('====================================');
    data.map((item) => {
      console.log(item);
...
useEffect(()=>{},[isload])
  ...
  var response;
   if (immediate) {
     ...
     console.log(authReducer.accessToken);

   response =   Cancelsubs(authReducer.accessToken);
    } else {
     console.log("timecancel");
     console.log(authReducer.accessToken);
        ...
        <div class="sec-3">
          ...
          <div class="subscription">
            ...
            <div class="row feature-border">
              ...
              <div className="col-lg-4 my_subs_div_2">
                <div class="col-lg-12">
                  <div class="sub-method">
                    <button  type="button"
                      class="btn us-active-btn cancelbtn" onClick={() => openModal()}>
                      Cancel Subscription
                    </button>
                    <h5>
                      <a href=""> </a>
            ...
            <div class="subscription">
              ...
              <p>click <Link to='/subscription'>here</Link> for subcription</p>
            </div>
          )
}
        </div>
